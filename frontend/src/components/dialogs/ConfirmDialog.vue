...
<template>
  <!-- 👉 Confirm Dialog -->
  <VDialog no-click-animation max-width="500" :model-value="props.isDialogVisible"
  ...
  <!-- Unsubscribed -->
  <VDialog v-model="unsubscribed" no-click-animation max-width="500">
    <VCard>
  ...
  <!-- Cancelled -->
  <VDialog v-model="cancelled" no-click-animation max-width="500">
    <VCard>
      <VCardText class="text-center px-10 py-6">
