    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <p>Date de validité: {{ $invoice['validity_date']?? 'N/A' }}</p>
            </div>
        </div>
        ...
        <div class="totals">
            <div class="totals-left">
                <p>Total TTC en lettres: {{ $invoice['total_in_words'] ?? 'N/A' }}</p>
                <p>Commentaire: {{ $invoice['comment'] ?? 'N/A' }}</p>
            </div>
            <div class="totals-right" style="margin-top:-500px;">
                <p>Total HT: {{ $invoice['total_ht'] ?? 0 }} DH</p>
                <p>Remise: {{ $invoice['discount'] ?? 0 }} DH</p>
                <p>TVA: {{ $invoice['tva'] ?? 0 }} DH</p>
                <p>Total TTC: {{ $invoice['total_ttc'] ?? 0 }} DH</p>
            </div>
        </div>

        <!-- Footer Section -->
        <div class="footer">
            <p>Nom juridique: {{ $invoice['customer_name'] ?? 'N/A' }}, ICE, IF, TP, RC?, Téléphone, Email, Site web, Adresse</p>
        </div>
    </div>
</body>
