    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <p>Date de validité: {{ $quote['validity_date']?? 'N/A' }}</p>
            </div>
        </div>
        ...
        <div class="client-info">
            ...
            <p>{{ $quote['customer_address'] ?? 'N/A' }}</p>
        </div>
        ...
        <div class="totals">
            <div class="totals-left">
                <p>Total TTC en lettres: {{ $quote['total_in_words'] ?? 'N/A' }}</p>
                <p>Commentaire: {{ $quote['comment'] ?? 'N/A' }}</p>
            </div>
            <div class="totals-right" style="margin-top:-500px;">
                <p>Total HT: {{ $quote['total_ht'] ?? 0 }} DH</p>
                <p>Remise: {{ $quote['discount'] ?? 0 }} DH</p>
                <p>TVA: {{ $quote['tva'] ?? 0 }} DH</p>
                <p>Total TTC: {{ $quote['total_ttc'] ?? 0 }} DH</p>
            </div>
        </div>

        <!-- Footer Section -->
        <div class="footer">
            <p>Nom juridique: {{ $quote['customer_name'] ?? 'N/A' }}, ICE, IF, TP, RC?, Téléphone, Email, Site web, Adresse</p>
        </div>
    </div>
</body>
