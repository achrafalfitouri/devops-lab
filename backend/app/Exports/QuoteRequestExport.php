...
class QuoteRequestExport implements FromCollection, WithHeadings
{
    ...
    public function __construct(QuoteRequestRepositoryInterface $quoteRepository, DocumentItemRepositoryInterface $documentItemRepository, array $filters, int $perPage)
    {
    ...
    {
        $query = $this->quoteRepository->getQuoteRequests();
        ...
        $this->documentItemRepository->setModel(QuoteRequestItem::class);
