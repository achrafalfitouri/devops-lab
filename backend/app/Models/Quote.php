...
class Quote extends Model
{
    ...
    {
        return $this->hasOne(OrderNote::class, 'quote_id', 'id');
    }

    public function productionNotes()
    {
        return $this->hasMany(ProductionNote::class, 'quote_id', 'id');
    }

    public function outputNotes()
    {
        return $this->hasMany(OutputNote::class, 'quote_id', 'id');
    }

    public function deliveryNotes()
    {
        return $this->hasMany(DeliveryNote::class, 'quote_id', 'id');
    }

    public function returnNotes()
    {
        return $this->hasMany(ReturnNote::class, 'quote_id', 'id');
    }

    public function orderReceipts()
    {
        return $this->hasMany(OrderReceipt::class, 'quote_id', 'id');
    }
    ...
    {
        return $this->hasMany(InvoiceCredit::class, 'quote_id', 'id');
    }
    public function quotes()
    {
        return $this->hasMany(Quote::class, 'id');
    }
    public function quoterequests()
    {
        return $this->hasMany(QuoteRequest::class, 'quote_id', 'id');
    }
